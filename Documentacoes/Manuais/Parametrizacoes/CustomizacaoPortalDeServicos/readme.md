...
4. **[Customização - Principal](#customização-principal)**
5. **[Customização - Rede de Atendimento](#customização-rede-de-atendimento)**
6. **[Customização - Favicon](#customização-favicon)**
7. **[Customização - Rodapé](#customização-rodapé)**
8. **[Lembretes](#lembretes)**

## Introdução

Neste manual será abordado de forma simples como alterar os temas pré-definidos do Portal(WES), plano de fundo da página de login e seu logo, rodapé, logo da página principal, o ícone que está localizado na aba do navegador e um exemplo de como aplicar scripts na página de login.
...
Inicialmente é necessário acessar o Portal de Serviços com usuário que possua papel “Desenvolvedor”, ativar o modo desenvolvimento, alterar o papel e então ativar a customização dos itens que serão alterados:

> Ativar Desenvolvimento
![001](src/images/001.png)

> Desenvolvedor > Configurações 
![002](src/images/002.png)

> Desenvolvedor > Configurações > Customização
![003](src/images/003.png)

>Desenvolvedor > Configurações > Customização > Ativar a customização dos itens que serão alterados
...
Após o tema criado, é necessário alterar o tema no Login50.aspx.
...
Também é necessário ajustar a customização da página de novo usuário, para isso é necessário copiar o arquivo “default.css” do caminho ~Content/css/Portal/Public/NovoUsuario para ~Content/css/public e renomeá-lo para “custom.css”.
...
Para alterar a logo da página principal é necessário ir na pasta do tema escolhido, criar um arquivo cópia do custom.css na camada 50 e nele alterar a imagem da logo.
...
Para customizar a rede de atendimento é necessário criar um css cópia do “index.css”, renomear o arquivo para “custom.css” e a partir deste ajustar o css como desejado.
...
Para alterar o ícone que é exibido no navegador é necessário substituir o arquivo “favicon50.ico” na pasta raiz da aplicação do Portal, é de extrema importância que o arquivo seja no formato ICO.
...
>Ícone no navegador depois de alterar o ícone
![057](src/images/057.png)

## Customização Rodapé

Para realizar a customização do rodapé, é necessário criar uma cópia do arquivo Rodape.ascx, renomear a cópia para "Rodape50.ascx". No arquivo "Default50.master" deve ser referenciado o caminho para o arquivo "Rodape50.ascx".
Ressaltando que é possível realizar esta customização somente se a **[customização da Master Page](#customização-geral)** estiver habilitada.

>Cópia do arquivo Rodapé, que se encontra na pasta "UserControlsPortal".
![058](src/images/058.png)

>O arquivo "Default50.master" deve referenciar o "rodape50.ascx".
![059](src/images/059.png)

>Para remover o logo ans é necessário comentar o seguinte trecho de código do arquivo "Rodape50.ascx".
![060](src/images/060.png)

![061](src/images/061.png)

>Para remover o ANS nº é necessário comentar o seguinte trecho de código do arquivo "Rodape50.ascx".
![062](src/images/062.png)

![063](src/images/063.png)
